const errorCodes = {
  ...
  EXTERNAL: { message: 'External service error', status: 500, code: 'EXTERNAL_ERROR' },
  DEV_IMPLEMENTATION: {
    message: 'Development implementation error',
    status: 500,
  ...
  FORBIDDEN: { message: 'Access forbidden', status: 403, code: 'FORBIDDEN_ERROR' },
  NO_ANONYMOUS_ACCESS: {
  ...
  DB: { message: 'Database error occurred', status: 500, code: 'DB_ERROR' },
};
